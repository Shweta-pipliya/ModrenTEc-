...
const handleImageChange = (event) => {
 ...
 setImage(event.target.files[0] )
  ...
  const [selectedColor, setSelectedColor] = useState('#ffce47');
    ...
    <div>
      ...
      <div className="image-Sec">
        ...
        <div className="m-img">
          ...
          <div  className="wall_photo" id="imageContainer" style={{ backgroundColor: selectedColor }}>
      ...
      <ul className="border-list">
        <li className="b-data" style={{ backgroundColor: 'black' }} onClick={() => handleColorClick('black')}></li>
        <li className="b-data2" style={{ backgroundColor: 'white' }} onClick={() => handleColorClick('white')}></li>
        <li className="b-data3" style={{ backgroundColor: '#ffce47' }} onClick={() => handleColorClick('#ffce47')}></li>
        <li className="b-data4" style={{ backgroundColor: 'red' }} onClick={() => handleColorClick('red')}></li>
      </ul>
    </div>
