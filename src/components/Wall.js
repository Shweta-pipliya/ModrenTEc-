...
// clock
const SecondHandStyled = styled.div`
  position: absolute;
  width: 230px;
  height: 230px;
  display: flex;
...
`;
const HourHandStyled = styled.div`
  &:before {
    content: '';
    position: absolute;
...
const MinHandStyled = styled.div`
  &:before {
    content: '';
    position: absolute;
    width: 4px;
    ...
    <div>
      ...
      <div className="image-Sec">
        ...
        <div className="m-img">
          ...
          <div className="clock">
  <div className="hour">
    <HourHandStyled rotation={(time.getHours() % 12) * 30 + time.getMinutes() / 60 * 30 + 'deg'} />
  </div>
  <div className="min">
    <MinHandStyled rotation={time.getMinutes() * 6 + 'deg'} />
  </div>
  <div className="sec">
    <SecondHandStyled rotation={time.getSeconds() * 6 + 'deg'} />
  </div>
